...
public class DogSorter {
    ...
    static public void sort(SortingAlgorithm algorithm, Comparator<Dog> comparator, Owner owner) {
    ...
    static public Dog[] sort(SortingAlgorithm algorithm, Comparator<Dog> comparator, Dog[] dogs) {
